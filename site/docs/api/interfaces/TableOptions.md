...
| ------ | ------ | ------ |
| <a id="align"></a> `align?` | (`"center"` \| `"left"` \| `"right"`)[] | - |
...
| <a id="id"></a> `id?` | `string` | - |
| <a id="interactive"></a> `interactive?` | `boolean` | Whether clicking or dragging rows focuses them interactively. Defaults to true. |
| <a id="opacity"></a> `opacity?` | `ReactiveProp`\<`number`\> | - |
| <a id="rotation"></a> `rotation?` | `ReactiveProp`\<`number`\> | - |
| <a id="rows"></a> `rows` | (`string` \| `number` \| `HTMLElement`)[][] | - |
